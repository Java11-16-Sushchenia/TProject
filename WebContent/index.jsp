	...
	<div class="authorization-error-modal">
		<div class="alert alert-danger fade in">
			<a href="#" class="close" data-dismiss="alert">x</a> <strong
				class="authorizationErrorType"></strong>: <span
			...
			<c:if test="${user == null }">
				<form class="navbar-form navbar-right authorize-user-form">
					<input name="login" required type="text" placeholder="${login}"
						class="form-control"> <input name="password" required
					...
					<div class="form-group">
						<button onclick="redirectToRegistrationPage();"
							class="button signupbutton">
							<span class="glyphicon glyphicon-log-in"></span>${signupbutton}</button>
					</div>
					...
					<li>
						<form action="Controller" method="get">
							<input type="hidden" name="command"
								...
								name="go_to_page" value="index" /> <a href="#"
			...
			<div class="col-sm-2 sidenav hidden-make-rate">
				<div class="well">
					...
					<form class="sendRateToController">
						...
						<p>
							Ставка:<input type="text" name="rate_money"
										...
										success : function(data) {
											...
											if (errorType === "authorizationerror") {
												...
												if (json["userRole"] === "ADMIN") {
													window.location
															.replace("redirectToAdminPage");
												}
												if (json["userRole"] === "BOOKMAKER") {
													window.location
															.replace("redirectToBookmakerPage");
												}
												if (json["userRole"] === "USER") {
													window.location
															.replace("redirectToUserPage");
												}
											}
										}
									});
